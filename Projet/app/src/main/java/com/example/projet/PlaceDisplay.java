...
public class PlaceDisplay extends AppCompatActivity {
        ...
        if (lvPlaces != null) {
            lvPlaces.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                    ...
                    boolean visitedItem= ((TextView)view.findViewById(R.id.tvVisited)).getText().toString().equalsIgnoreCase("Visited");

                    Place pPlace = new Place(placeId, titleItem, descriptionItem, dateItem, timeItem, addressItem, phoneItem, visitedItem);
    ...
    public void chargeData(){
        final String[] from = new String[]{DatabaseHelper.COL_ID, DatabaseHelper.COL_TITLE, DatabaseHelper.COL_DATE, DatabaseHelper.COL_VISITED, DatabaseHelper.COL_DESC, DatabaseHelper.COL_TIME, DatabaseHelper.COL_ADDRESS, DatabaseHelper.COL_PHONE};
        final int[] to = new int[]{R.id.tvId, R.id.tvTitle, R.id.tvDate, R.id.tvVisited, R.id.tvDescription, R.id.tvTime, R.id.tvAddress, R.id.tvPhone};
        Cursor c = myHelper.getAllPlaces();
        ...
        adapter.setViewBinder(new SimpleCursorAdapter.ViewBinder() {
            ...
            public boolean setViewValue(View view, Cursor cursor, int columnIndex) {
                if (view.getId() == R.id.tvVisited) {
                    ...
                    ((TextView) view).setText(visited == 1 ? "Visited" : "Not Visited");
                    return true;
                }
                return false;
            }
